...
class ExplicitWaitUtilitiesDemoExpediaCalender {
	WebDriver driver;
	String baseUrl;
	GenericMethods gm;
	@BeforeEach
	...
	void test1() throws InterruptedException {
		...
		gm.waitUntilElementIsReadyToBeClicked(By.xpath("//div[@class='datepicker-cal-month'][position()=1]//button[text()='30']"), 5);
	...
	void test2() throws InterruptedException {
		...
		List<WebElement> validDates = calMonth.findElements(By.xpath("//button[not(@disabled)]"));
